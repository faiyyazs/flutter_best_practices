    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `province` (`id` INTEGER, `name` TEXT, PRIMARY KEY (`id`))');
...
class _$ProvinceDao extends ProvinceDao {
  _$ProvinceDao(this.database, this.changeListener)
  ...
  Future<List<ProvinceDBEntity>> getProvinces() async {
    return _queryAdapter.queryList('SELECT * FROM province',
        mapper: (Map<String, dynamic> row) => ProvinceDBEntity(
